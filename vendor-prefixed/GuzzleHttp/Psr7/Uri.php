...
use NoBg\GuzzleHttp\Psr7\Exception\MalformedUriException;
...
class Uri implements UriInterface, \JsonSerializable
{
     ...
     * `NoBg\Psr\Http\Message\UriInterface::__toString`.
     *
     ...
     *
     * `NoBg\Psr\Http\Message\UriInterface::getPort` may return null or the standard port. This method can be used
